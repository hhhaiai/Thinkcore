 ...
 * {@link TAsyncHttpClient}. Receives response body as byte array with a
 ...
 * </pre>
 */
public abstract class BinaryHttpResponseHandler extends
		AsyncHttpResponseHandler {

	private static final String TAG = BinaryHttpResponseHandler.class
			.getSimpleName();
	...
	public BinaryHttpResponseHandler(String[] allowedContentTypes) {
		...
		if (allowedContentTypes != null)
			...
			TLog.e(TAG, "Constructor passed allowedContentTypes was null !");
	}
	...
	public final void sendResponseMessage(HttpResponse response)
		...
		for (String anAllowedContentType : getAllowedContentTypes()) {
			try {
				...
				Log.e("BinaryHttpResponseHandler",
						"Given pattern is not valid: " + anAllowedContentType,
						e);
			}
		}
