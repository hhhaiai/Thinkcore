 ...
 * {@link TAsyncHttpClient#setCookieStore}, but can also be used with a regular
...
public class PersistentCookieStore implements CookieStore {
	...
	public PersistentCookieStore(Context context) {
		...
		String storedCookieNames = mCookiePrefs.getString(COOKIE_NAME_STORE,
				null);
		if (storedCookieNames != null) {
			String[] cookieNames = TextUtils.split(storedCookieNames, ",");
			for (String name : cookieNames) {
				String encodedCookie = mCookiePrefs.getString(
	...
	public void addCookie(Cookie cookie) {
		if (mOmitNonPersistentCookies && !cookie.isPersistent())
			return;
	...
	public boolean clearExpired(Date date) {
		...
		for (ConcurrentHashMap.Entry<String, Cookie> entry : mCookies
				.entrySet()) {
	...
	public List<Cookie> getCookies() {
		return new ArrayList(mCookies.values());
	}
	...
	protected Cookie decodeCookie(String cookieString) {
		...
		try {
			...
			TLog.d(LOG_TAG, "decodeCookie failed" + exception.getMessage());
		}
