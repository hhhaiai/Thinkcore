...
import com.treecore.storage.TStorage.StorageType;
import com.treecore.storage.helpers.OrderType;
import com.treecore.storage.helpers.SizeUnit;
...
public interface Storage {
	...
	/**
	 * Get all files and directories under the directory that match the regex
	 * pattern on their full names.<br>
	 * <br>
	 * For example, we want to get only image files. And this our directory
	 * status:
	 * 
	 * <pre>
	 * my_dir | -image1.jpg | -image2.png | -not_image1.txt | -not_image2.psd | -dir1
	 * 		| -image3.gif
	 * </pre>
	 * 
	 * The code:
	 ...
	 * 
	 * <pre>
	 * my_dir | -image1.jpg | -image2.png | -image3.gif
	 * </pre>
	 * 
	 * @param directoryName
	 * @param matchRegex
	 *            Set regular expression to match files you need. Or set
	 *            <code>null</code> to get all files.
	 */
