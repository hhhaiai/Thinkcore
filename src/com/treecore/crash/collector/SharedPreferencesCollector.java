 ...
 */
final class SharedPreferencesCollector {// modify
	...
	public static String collect(Context context) {
		...
		// final String[] shrdPrefsIds =
		// TAcra.getConfig().additionalSharedPreferences();
		// if (shrdPrefsIds != null) {
		// for (final String shrdPrefId : shrdPrefsIds) {
		// shrdPrefs.put(shrdPrefId, context.getSharedPreferences(shrdPrefId,
	...
	private static boolean filteredKey(String key) {
		// for (String regex : TAcra.getConfig()
