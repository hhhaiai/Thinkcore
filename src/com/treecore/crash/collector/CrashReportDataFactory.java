...
import static com.treecore.crash.data.ReportField.ANDROID_VERSION;
import static com.treecore.crash.data.ReportField.APP_VERSION_CODE;
import static com.treecore.crash.data.ReportField.APP_VERSION_NAME;
import static com.treecore.crash.data.ReportField.AVAILABLE_MEM_SIZE;
import static com.treecore.crash.data.ReportField.BRAND;
import static com.treecore.crash.data.ReportField.BUILD;
import static com.treecore.crash.data.ReportField.CRASH_CONFIGURATION;
import static com.treecore.crash.data.ReportField.CUSTOM_DATA;
import static com.treecore.crash.data.ReportField.DEVICE_FEATURES;
import static com.treecore.crash.data.ReportField.DEVICE_ID;
import static com.treecore.crash.data.ReportField.DISPLAY;
import static com.treecore.crash.data.ReportField.DUMPSYS_MEMINFO;
import static com.treecore.crash.data.ReportField.ENVIRONMENT;
import static com.treecore.crash.data.ReportField.FILE_PATH;
import static com.treecore.crash.data.ReportField.INITIAL_CONFIGURATION;
import static com.treecore.crash.data.ReportField.INSTALLATION_ID;
import static com.treecore.crash.data.ReportField.PACKAGE_NAME;
import static com.treecore.crash.data.ReportField.PHONE_MODEL;
import static com.treecore.crash.data.ReportField.PRODUCT;
import static com.treecore.crash.data.ReportField.SETTINGS_SECURE;
import static com.treecore.crash.data.ReportField.SETTINGS_SYSTEM;
import static com.treecore.crash.data.ReportField.SHARED_PREFERENCES;
import static com.treecore.crash.data.ReportField.STACK_TRACE;
import static com.treecore.crash.data.ReportField.THREAD_DETAILS;
import static com.treecore.crash.data.ReportField.TOTAL_MEM_SIZE;
import static com.treecore.crash.data.ReportField.USER_CRASH_DATE;
