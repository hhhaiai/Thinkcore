...
/**
 * This is an abstract cursor class that handles a lot of the common code that
 * all cursors need to deal with and is provided for convenience reasons.
 */
public abstract class AbstractCursor implements CrossProcessCursor {
	...
	public int getType(int column) {
		// Reflects the assumption that all commonly used field types (meaning
		// everything
	...
	public boolean requery() {
		if (mSelfObserver != null && mSelfObserverRegistered == false) {
			// TODO
			// mContentResolver.registerContentObserver(mNotifyUri, true,
			// mSelfObserver);
	...
	public int getColumnIndex(String columnName) {
		...
		if (periodIndex != -1) {
			...
			TLog.e(TAG, "requesting column name with table name -- "
					+ columnName, e);
		...
		if (false) {
			if (getCount() > 0) {
				TLog.w(TAG, "Unknown column " + columnName);
			}
		}
		return -1;
	}
	...
	/**
	 * Subclasses must call this method when they finish committing updates to
	 ...
	 * <code>null</code> will be converted into {@link Bundle#EMPTY}.
	 * 
	 * @param extras
	 *            {@link Bundle} to set.
	 * @hide
	...
	/**
	 * @deprecated Always returns false since Cursors do not support updating
	 *             rows
	 */
	@Deprecated
	...
	/**
	 * @deprecated Always returns null since Cursors do not support updating
	 *             rows
	 */
	@Deprecated
	...
	/**
	 * This function throws CursorIndexOutOfBoundsException if the cursor
	 * position is out of bounds. Subclass implementations of the get functions
	 * should call this before attempting to retrieve data.
	 * 
	...
	/**
	 * This must be set to the index of the row ID column by any subclass that
	 * wishes to support updates.
	 */
	protected int mRowIdColumnIndex;

	protected int mPos;
	/**
	 * If {@link #mRowIdColumnIndex} is not -1 this contains contains the value
	 * of the column at {@link #mRowIdColumnIndex} for the current row this
