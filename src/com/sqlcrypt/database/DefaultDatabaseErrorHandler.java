 ...
 *      com.sqlcrypt.database.sqlite.SQLiteDatabase.CursorFactory, DatabaseErrorHandler)}</li>
 *   <li>{@link SQLiteDatabase#openDatabase(String,
 *      com.sqlcrypt.database.sqlite.SQLiteDatabase.CursorFactory, int, DatabaseErrorHandler)}</li>
 * </ul>
...
public final class DefaultDatabaseErrorHandler implements DatabaseErrorHandler {
    ...
    public void onCorruption(SQLiteDatabase dbObj) {
    	TLog.e(TAG, "Corruption reported by sqlite on database: " + dbObj.getPath());
    ...
    private void deleteDatabaseFile(String fileName) {
        ...
        TLog.e(TAG, "deleting the database file: " + fileName);
        try {
            new File(fileName).delete();
        } catch (Exception e) {
            /* print warning and ignore exception */
        	TLog.w(TAG, "delete failed: " + e.getMessage());
        }
    }
}
