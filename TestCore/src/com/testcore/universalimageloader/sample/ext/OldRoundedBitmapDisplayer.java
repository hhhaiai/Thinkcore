 ...
 *******************************************************************************/
package com.testcore.universalimageloader.sample.ext;

import com.universalimageloader.assist.LoadedFrom;
import com.universalimageloader.display.BitmapDisplayer;
import com.universalimageloader.imageaware.ImageAware;
import com.universalimageloader.imageaware.ImageViewAware;
...
/**
 * Displays bitmap with rounded corners. This implementation works only with
...
public class OldRoundedBitmapDisplayer implements BitmapDisplayer {
	...
	public void display(Bitmap bitmap, ImageAware imageAware,
		...
		Bitmap roundedBitmap = roundCorners(bitmap,
				(ImageViewAware) imageAware, roundPixels);
	 ...
	 *            ImageAware} to display bitmap in
	 * @param roundPixels
