...
public class RippleView2 extends Button {
    ...
    public RippleView2(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.RippleView2);
        mRippleColor = a.getColor(R.styleable.RippleView2_rippleColor2,
                mRippleColor);
        mAlphaFactor = a.getFloat(R.styleable.RippleView2_alphaFactor2,
                mAlphaFactor);
        mHover = a.getBoolean(R.styleable.RippleView2_hover2, mHover);
        a.recycle();
    }
        ...
        if (event.getActionMasked() == MotionEvent.ACTION_DOWN
            ...
            mRadiusAnimator.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animator) {
                    setRadius(0);
                    ViewHelper.setAlpha(RippleView2.this, 1);
                    mIsAnimating = false;
                }
