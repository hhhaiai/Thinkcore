...
public class MaterialTextField extends EditText {
	...
	private void setup() {
		...
		bgDrawable = null;//(NinePatchDrawable) getResources().getDrawable(R.drawable.);
		barDrawable = null;//(NinePatchDrawable) getResources().getDrawable(R.drawable.textfield_activated);
