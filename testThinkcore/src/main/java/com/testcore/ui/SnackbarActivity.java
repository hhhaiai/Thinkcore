...
public class SnackbarActivity extends AppCompatActivity implements SnackBarListener, View.OnClickListener {
    private static final String TAG = SnackbarActivity.class.getSimpleName();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.sb_action_toggle:
                SnackBar.show(SnackbarActivity.this, "This is a SnackBar with an action", "COOL", (SnackBarListener) SnackbarActivity.this);
                break;
