 ...
 *******************************************************************************/
package com.thinkcore.cache.disc.impl;
...
import com.thinkcore.cache.disc.DiskCache;
import com.thinkcore.cache.disc.naming.FileNameGenerator;
import com.thinkcore.cache.disc.naming.HashCodeFileNameGenerator;
import com.thinkcore.utils.TIoUtils;
...
public abstract class BaseDiskCache implements DiskCache {
	...
	public boolean save(String imageUri, InputStream imageStream,
			TIoUtils.CopyListener listener) throws IOException {
		...
		try {
			OutputStream os = new BufferedOutputStream(new FileOutputStream(
					tmpFile), bufferSize);
			try {
				loaded = TIoUtils.copyStream(imageStream, os, listener,
						bufferSize);
			} finally {
