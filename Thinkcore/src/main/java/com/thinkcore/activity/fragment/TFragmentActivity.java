...
public class TFragmentActivity extends FragmentActivity implements
		TITaskListener {
	private static String TAG = TFragmentActivity.class.getSimpleName();
	...
	// public void pushFragments(TFragment fragment) {
	// FragmentManager manager = getSupportFragmentManager();
	// FragmentTransaction ft = manager.beginTransaction();
	// ft.replace(fragment.getFragmentId(), fragment);
	// ft.commit();
	// }
	//
