...
import com.thinkcore.activity.TActivity.Status;
...
public class TActivityGroup extends ActivityGroup implements TITaskListener {
	public static String TAG = TActivityGroup.class.getCanonicalName();
