...
public abstract class DataAsyncHttpResponseHandler extends
		AsyncHttpResponseHandler {
	private static final String TAG = DataAsyncHttpResponseHandler.class
			.getSimpleName();
	...
	protected void handleMessage(Message message) {
		...
		case PROGRESS_DATA_MESSAGE:
			...
			if (response != null && response.length >= 1) {
				...
				TLog.e(TAG, "PROGRESS_DATA_MESSAGE didn't got enough params");
			}
			break;
		}
	}
