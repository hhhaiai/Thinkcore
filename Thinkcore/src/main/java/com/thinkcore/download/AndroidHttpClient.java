...
public final class AndroidHttpClient implements HttpClient {
	...
	public static AndroidHttpClient newInstance(String userAgent,
		...
		schemeRegistry.register(new Scheme("http", PlainSocketFactory
				.getSocketFactory(), 80));
		SSLSocketFactory aDefault = SSLCertificateSocketFactory.getDefault(SOCKET_OPERATION_TIMEOUT, sessionCache);
		schemeRegistry.register(new Scheme("https", (SocketFactory) aDefault,443));
